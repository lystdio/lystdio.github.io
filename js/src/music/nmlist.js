...
var NM = {
  ...
  render: function() {
    var xtpl = '<li data-id="{id}" data-start="&#xe60e;" data-pause="&#xe608;"><img data-src="{cover}?param=280y280" alt="{title}">' +
    '<span>{title}</span><b>{count}</b></li>';
    var str = '<div id="nmlist"><h2>撼地神牛的歌单</h2><i class="icon" data-start="&#x261e;" data-pause="&#xe600;"></i><ul>';
